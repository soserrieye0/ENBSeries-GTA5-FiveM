...
enum ENBStateType : long
{
	...
	ENBState_fTODFactorInteriorDay	=18, //time weight 0..1 range //UNUSED in GTA5
	ENBState_fTODFactorInteriorNight=19, //time weight 0..1 range //UNUSED in GTA5
	ENBState_fNightDayFactor	=20, //time weight 0..1 range
	ENBState_fInteriorFactor	=21, //time weight 0..1 range
	ENBState_ulWorldSpaceID		=22, //as unsigned long //UNUSED in GTA5
	ENBState_ulLocationID		=23, //as unsigned long //UNUSED in GTA5
